...
user_pref("network.proxy.socks_remote_dns", true); //отключить отправку DNS в обход настроек прокси. dns-запросы тоже будут отправляться через туннель
...
user_pref("media.peerconnection.enabled", false); //WebRTC Leak Prevent.
...
user_pref("dom.enable_performance", false); //отвечает за передачу информации серверу о времени начала и конца загрузки страницы. Анализ этих данных может позволить определить факт наличия прокси.
user_pref("dom.indexedDB.enabled", false); 
user_pref("extensions.blocklist.enabled", true); //Разрешить или нет Firefox блокировать расширения и плагины из "чёрного списка", который составляется разработчиками браузера.
user_pref("media.video_stats.enabled", false); // Отвечает за отправку статистики о воспроизведении видео (кол-во пропущенных/отрендеренных кадров, и т.д.) 
user_pref("privacy.trackingprotection.enabled", true);
user_pref("dom.network.enabled", true); //позволяет определять параметры соединения пользователя с сетью.
user_pref("browser.sessionstore.interval", 15000000); //ssd optim
user_pref("browser.sessionstore.restore_on_demand", false); //ssd optim
user_pref("browser.sessionstore.resume_from_crash", false); //ssd optim
user_pref("services.sync.prefs.sync.browser.sessionstore.restore_on_demand", false); //ssd optim
